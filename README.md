...
## Dataset: GeneTAK
GeneTAK is derived from the Tahoe-100M single-cell atlas and focuses on gene-level perturbation responses. You can download the preprocessed raw data from[https://drive.google.com/file/d/1vHqkjg12jm0BJJSSoBMCVdFm6jKFr9ZI/view?usp=sharing](https://drive.google.com/file/d/1vHqkjg12jm0BJJSSoBMCVdFm6jKFr9ZI/view?usp=sharing),and the constructed open world knowledge graph from [https://doi.org/10.5281/zenodo.18513982](https://doi.org/10.5281/zenodo.18513982).
